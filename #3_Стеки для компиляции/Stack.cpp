...
// * 判断当前运算符与栈顶运算符的优先级大小
// */
//bool isPriorityLow(char currOper, char  p_topOper) {
//	if (currOper == '+' || currOper == '-') {
//		if ( p_topOper == '*' ||  p_topOper == '/' ||  p_topOper == '+' ||  p_topOper == '-') {
//			return true;
//		}
//	}
//
//	if (currOper == '*' || currOper == '/') {
//		if ( p_topOper == '*' ||  p_topOper == '/') {
//			return true;
//		}
//	}
//
...
//	if (operators.size() > 0 && isPriorityLow(oper, operators. p_top())) {
//		s += operators. p_top();
//		operators.pop();
...
//		}
//		else if (isPriorityLow(oper, operators. p_top())) {
//			loopPushOperator(s, oper, operators);
//			operators.push(oper);
...
//	}
//	//栈是先进后出,所以先弹出的是第二个值
//	int secondVal = tmpStack. p_top();
//	tmpStack.pop();
//	int firstVal = tmpStack. p_top();
//	tmpStack.pop();
//
//	int result = 0;
//	switch (oper) {
